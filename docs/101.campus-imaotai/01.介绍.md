...
因很多人员进群并非**技术交流**，为了避免沟通成本和维护群内交流环境，本群仅限制**技术/开发**人员，请发邮件 <a href="mailto:zy+campus-imaotai-group@cx.cx?subject=campus-imaotai申请入群" target="_top">zy+campus-imaotai-group@cx.cx</a> ，叙述您的**技术栈**，留下您的微信添加方式，看到后符合信息者我会添加您并拉您进群
